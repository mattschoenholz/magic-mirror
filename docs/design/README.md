...
- `tokens.md` — color, type, spacing, night mode; note **minimum sizes for ~10 ft** vs **~2–3 ft**
- `layout-1080x1920.svg` — **portrait** full-screen mockup (or markdown that embeds it); add **variants** or notes for **passive** vs **pomodoro_focus** if hierarchy differs strongly
- `module-priority.md` — visual hierarchy **per mode** where it changes
